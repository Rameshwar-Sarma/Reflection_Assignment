...
namespace EmployeeCRUD.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public EmployeeController(EmployeeContext context, IMapper mapper, ReflectionSerializationService serializationService, ReflectionHelperService reflectionHelperService)
        {
            _context = context;
            _mapper = mapper;
